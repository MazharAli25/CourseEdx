...
@section('content')
    ...
    <div class="card">
        <div class="card-header d-flex align-items-center">
            <h5 class="mb-0">Privacy Policies List</h5>
        ...
        <div class="card-body table-responsive p-0">
            <table class="table table-bordered table-hover text-nowrap policy-table">
    ...
    <script>
        ...
        // Handle status change
            $(document).on('change', '.status-dropdown', function() {
                const dropdown = $(this);
                const policyId = dropdown.data('id');
                ...
                $.ajax({
                    url: "{{ url('/super-admin/privacy-policy/update-status') }}/" + policyId,
                    type: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}',
                        policyId: policyId,
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                $.ajax({
                    url: `/super-admin/privacy-policy/${id}`,
                    type: 'DELETE',
                    data: {
                        _token: '{{ csrf_token() }}',
                    },
                    success: function(response) {
                        if (response.success) {
                            ...
                            $('.policy-table').DataTable().ajax.reload(null, false);
                        } else {
                            if (typeof toastr !== 'undefined') {
