    ...
    <div class="row">
            ...
            <div class="card card-primary card-outline">
                <div class="card-body box-profile text-center">
                    ...
                    <img id="profilePreview" class="profile-user-img img-fluid img-circle mb-2"
                        src="{{ auth()->user()->image ? asset(auth()->user()->image) : asset('images/default-avater.jfif') }}" alt="Profile Picture"
        ...
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <form action="{{ route('student.profile.update', auth()->user()) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
